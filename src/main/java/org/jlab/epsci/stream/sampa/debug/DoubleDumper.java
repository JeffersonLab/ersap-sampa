...
public class DoubleDumper {
    ...
    public void go() {
        ReceiveAndDumper receiver1 = new ReceiveAndDumper(sampaPort1, streamId1, streamFrameLimit, sType, byteSize);
        ReceiveAndDumper receiver2 = new ReceiveAndDumper(sampaPort2, streamId2, streamFrameLimit, sType, byteSize);
