 ...
 * @author timmer
 */
public class S2StreamAggregator extends Thread {
     ...
     */
    public S2StreamAggregator(int sampaPort1, int sampaPort2,
        ...
        RingBuffer<SRingRawEvent> ringBuffer1 = createSingleProducer(new SRingRawEventFactory(sType, byteSize, false), maxRingItems,
...
//        new YieldingWaitStrategy());
        ...
        RingBuffer<SRingRawEvent> ringBuffer2 = createSingleProducer(new SRingRawEventFactory(sType, byteSize, false), maxRingItems,
                new SpinCountBackoffWaitStrategy(30000, new LiteBlockingWaitStrategy()));
//        new YieldingWaitStrategy());
