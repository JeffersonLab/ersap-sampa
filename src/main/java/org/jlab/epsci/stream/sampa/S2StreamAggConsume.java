...
public class S2StreamAggConsume {
     ...
     * @param sType        type of data coming over TCP sockets.
     */
    public S2StreamAggConsume(int sampaPort1, int sampaPort2,
        ...
        ringBuffer1 = createSingleProducer(new SRingRawEventFactory(sType, byteSize, false), maxRingItems,
        ...
        ringBuffer2 = createSingleProducer(new SRingRawEventFactory(sType, byteSize, false), maxRingItems,
                new SpinCountBackoffWaitStrategy(30000, new LiteBlockingWaitStrategy()));
        ...
        ringBuffer12 = createSingleProducer(new SRingRawEventFactory(sType, byteSize, true), maxRingItems,
                new SpinCountBackoffWaitStrategy(30000, new LiteBlockingWaitStrategy()));
    ...
    public void go() throws IOException {
        receiver1 = new SReceiverDecoder(sampaPort1, streamId1, ringBuffer1, streamFrameLimit, sType, byteSize);
        receiver2 = new SReceiverDecoder(sampaPort2, streamId2, ringBuffer2, streamFrameLimit, sType, byteSize);
    ...
    public static void main(String[] args) {
        ...
        try {
            new S2StreamAggConsume(port1, port2, streamId1, streamId2,
