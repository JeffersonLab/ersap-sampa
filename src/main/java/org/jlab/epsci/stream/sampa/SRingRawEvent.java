...
public class SRingRawEvent {
     ...
     */
    public SRingRawEvent(SType type) {this(type, 131072, false);}
     ...
     */
    public SRingRawEvent(SType type, int byteSize, boolean forAggregation) {
        sType = type;
     ...
     */
    public SType getSampaType() {return sType;}
