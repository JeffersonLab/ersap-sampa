...
import org.jlab.epsci.stream.sampa.S2StreamAggregator;
 ...
 * @author timmer
 */
public class SampaSourceEngine extends AbstractEventReaderService<S2StreamAggregator> {
    ...
    @Override
    protected S2StreamAggregator createReader(Path file, JSONObject opts)
        ...
        try {
            S2StreamAggregator v =
                    new S2StreamAggregator(port1, port2,
                            1, 2,
                            0, SType.DAS);
